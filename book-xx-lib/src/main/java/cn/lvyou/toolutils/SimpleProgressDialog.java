...
/**
 * 对 ProgressDialog 的简单封装 特点 : 1.调用者必须保证 show() 和 dismiss()的成对调用; 2.包含引用计数器机制, 不会创建多个ProgressDialog实例, 当最后一个引用计数器为0时,才会销毁ProgressDialog对象 3.在Activity中的 onDestroy()中调用此reset()方法
 * 
 * @author zhihua.tang
 */
