    ...
    public void onClick(View v) {
      ...
      switch (v.getId()) {
        case R.id.categoryDatesTextView:
          for (CategoryDate categoryDate : categoryNetRespondBean.getDates()) {
        ...
        case R.id.categoryTypesTextView:
          for (CategoryType categoryType : categoryNetRespondBean.getTypes()) {
            TextView textView = new TextView(getActivity());
            textView.setTextSize(19f);
            textView.setGravity(Gravity.CENTER_VERTICAL);
            textView.setTextColor(getResources().getColor(android.R.color.black));
            textView.setText(categoryType.getCateName());
            listViewInCategoryPopupWindow.addView(textView, new LinearLayout.LayoutParams(LayoutParams.MATCH_PARENT, 85));
          }
          break;
        case R.id.categoryOriginPlaceTextView:
          for (CategoryOriginPlace categoryOriginPlace : categoryNetRespondBean.getOriginPlace()) {
            TextView textView = new TextView(getActivity());
            textView.setTextSize(19f);
            textView.setGravity(Gravity.CENTER_VERTICAL);
            textView.setTextColor(getResources().getColor(android.R.color.black));
            textView.setText(categoryOriginPlace.getCityDes());
            listViewInCategoryPopupWindow.addView(textView, new LinearLayout.LayoutParams(LayoutParams.MATCH_PARENT, 85));
          }
          break;
        case R.id.categoryPlaceTextView:
          for (CategoryPlace categoryPlace : categoryNetRespondBean.getPlaces()) {
            TextView textView = new TextView(getActivity());
            textView.setTextSize(19f);
            textView.setGravity(Gravity.CENTER_VERTICAL);
            textView.setTextColor(getResources().getColor(android.R.color.black));
            textView.setText(categoryPlace.getContinentName());
            listViewInCategoryPopupWindow.addView(textView, new LinearLayout.LayoutParams(LayoutParams.MATCH_PARENT, 85));
          }
          break;
